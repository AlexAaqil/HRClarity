...
def employees():
    ...
    employees_count = Employee.query.count()
    return render_template('employees.html', page_title='Employees', employees=employees, employees_count=employees_count, user=current_user)
...
def update_employee(employee_id):
    ...
    return render_template('add_employee.html', page_title='Update Employee', form=form, user=current_user)
...
def delete_employee(employee_id):
    ...
    return render_template('employees.html', page_title='Employees')
...
def departments():
    ...
    departments_count = Department.query.count()
    return render_template('departments.html', page_title='Departments', departments=departments, departments_count=departments_count, user=current_user)
...
def add_department():
    ...
    return render_template('add_department.html', page_title='Add Department', form=form, user=current_user)
...
def update_department(department_id):
    ...
    return render_template('add_department.html', page_title='Update Department', form=form, user=current_user)
...
def delete_department(department_id):
    ...
    return render_template('departments.html', page_title='Departments')
...
def occupations():
    ...
    occupations_count = Occupation.query.count()
    return render_template('occupations.html', page_title='Occupations', occupations=occupations, occupations_count=occupations_count, user=current_user)
...
def add_occupation():
    ...
    return render_template('add_occupation.html', page_title='Add Occupation', form=form, user=current_user)
...
def update_occupation(occupation_id):
    ...
    return render_template('add_occupation.html', page_title='Update Occupation', form=form, user=current_user)
